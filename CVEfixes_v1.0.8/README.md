...
# _CVEfixes_ Dataset v1.0.8: Automatically Collected Vulnerabilities and Their Fixes from Open-Source Software (July 2024)
...
This release, v1.0.8, covers all published CVEs up to 23 July 2024.
...
database and covers 12107 vulnerability fixing commits in 4249 open
source projects for a total of 11873 CVEs in 272 different Common
Weakness Enumeration (CWE) types. The dataset includes the source
code before and after changing 51342 files and 138974 functions. 
The collection took 48 hours with 4 workers (AMD EPYC Genoa-X 9684X).
